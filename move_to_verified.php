...
$textmessage = 'Dear Mr/Ms. <br> We would like to inform you that the details/image you sent to us has matched with the item that we had. You may now claim it here at the Item Lost and Found. Just present the attached QR Code and the password provided! <br> Thank you! <br> Item No: '.$itemNo.' and password is: <h5>'.$qrPass.'</h5> <br> <img class="xqr" src="https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl='.md5($itemNo).'">';
